{ pkgs, stdenv, fetchFromGitHub, nim, libX11, libXrandr, libGL, nim_1_0 }:
...
in stdenv.mkDerivation rec {
  ...
  fixupPhase = "patchelf --set-rpath ${pkgs.lib.makeLibraryPath [stdenv.cc.cc libX11 libXrandr libGL]} $out/bin/boomer";
}
